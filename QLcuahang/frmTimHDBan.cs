...
namespace QLcuahang
{
    public partial class frmTimHDBan : Form
    {
        ...
        private void btnTimKiem_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Hãy nhập Thông Tin tìm kiếm!!!", "Yêu cầu ...", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            ...
            if (tblHDB.Rows.Count == 0)
            {
                ...
                MessageBox.Show("Có " + tblHDB.Rows.Count + " Thông Tin  Cần Tìm!", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void LoadDataGridView()
        {
            ...
            this.dgvTKHoaDon.DefaultCellStyle.ForeColor = Color.White;
            this.dgvTKHoaDon.DefaultCellStyle.BackColor = Color.Black;
        }
