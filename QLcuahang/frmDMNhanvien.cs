...
namespace QLcuahang
{
    public partial class frmDMNhanvien : Form
    {
        ...
        private void LoadDataGridView()
        {
            ...
            this.dgvNhanVien.DefaultCellStyle.ForeColor = Color.White;
            this.dgvNhanVien.DefaultCellStyle.BackColor = Color.Black;
        }
        ...
        {
            string sql, gt;
            if (txtMaNhanVien.Text.Trim().Length == 0) // check khoảng trắng 2 đầu
            {
