...
namespace QLcuahang
{
    public partial class frmDMKhachHang : Form
    {
        ...
        private void LoadDataGridView()
        {
            ...
            this.dgvKhachHang.DefaultCellStyle.ForeColor = Color.White;
            this.dgvKhachHang.DefaultCellStyle.BackColor = Color.Black;
        }
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            sql = "UPDATE tblKhach SET TenKhach=N'" + txtTenKhach.Text.Trim().ToString() + "',DiaChi=N'" +
                txtDiaChi.Text.Trim().ToString() + "',SoDienThoai='" + mtbDienThoai.Text.ToString() +
